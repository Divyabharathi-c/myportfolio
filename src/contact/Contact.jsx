    ...
    <div className="contact" id="contact">
      ...
      <div className='contact-content'>
        <div className='mini-icons'>
          <div style={{backgroundColor: 'black'}} title="Github"><a href="https://github.com/Divyabharathi-c" target="_blank"><AiOutlineGithub className='side-btn'/></a></div>
          <div style={{backgroundColor: 'blue'}} title="LinkedIn"><a href="https://www.linkedin.com/in/divyabharathi-c-570814283/" target="_blank"><AiFillLinkedin className='side-btn'/></a></div>
          <div style={{backgroundColor: 'crimson'}} title="G-mail"><a href="https://www.linkedin.com/in/divyabharathi-c-570814283/overlay/contact-info/" target="_blank"><AiOutlineMail className='side-btn'/></a></div>

        </div>
        <div className="contact-buttons">
          <a href='https://github.com/Divyabharathi-c'><button className='github-btn'><span>< AiOutlineGithub className='bbb'/></span>Github</button></a>
          <a href='https://www.linkedin.com/in/divyabharathi-c-570814283/'><button className='linkedin-btn'><span><AiFillLinkedin className='bbb'/></span>Linked In</button></a>
          <a href='https://www.linkedin.com/in/divyabharathi-c-570814283/overlay/contact-info/'><button className='gmail-btn'><span><AiOutlineMail className='bbb'/></span>Gmail</button></a>
        </div>
